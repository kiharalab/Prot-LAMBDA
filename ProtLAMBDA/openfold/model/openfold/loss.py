...
from model.openfold.affine_utils import T
...
def compute_fape(
    ...
    # print(pred_frames.rots.size())
    # print(local_pred_pos.size())
    # print(local_target_pos.size())
    # print(frames_mask.size())
    # print(positions_mask.size())
    # print(torch.sum(frames_mask))
    # print(torch.sum(positions_mask))
    # print('='*50)
...
def sidechain_loss(
    ...
    **kwargs,
    ...
    #print(sidechain_atom_pos.size())
    #print(rigidgroups_gt_frames.size())
    #print(rigidgroups_alt_gt_frames.size())
    #print('='*50)
    ...
    # print(sidechain_frames.rots.size())
    # # print(renamed_gt_frames.size())
    # print(rigidgroups_gt_exists.size())
    # print(sidechain_atom_pos.size())
    # print(renamed_atom14_gt_positions.size())
    # print(renamed_atom14_gt_exists.size())
    # print(torch.sum(renamed_atom14_gt_exists))
    # print('='*50)
    fape = compute_fape(
        sidechain_frames,
        renamed_gt_frames,
